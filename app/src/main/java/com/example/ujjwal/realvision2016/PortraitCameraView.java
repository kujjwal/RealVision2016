            ...
            for (int i = 0; i < numberOfCameras; i++) {
                ...
                if (cameraInfo.facing == android.hardware.Camera.CameraInfo.CAMERA_FACING_BACK) {
                    try {
                        ...
                        Log.e(TAG, "Camera #" + i + "failed to open: " + e.getMessage(), e);
                    }
                    if (connected) break;
                }
            }
            ...
            try {
                ...
                /* Select the size that fits surface considering maximum size allowed */
                    ...
                    if (mFpsMeter != null) {
                        ...
                        //mFpsMeter.setResolution(640, 640);
                    }
...
// */
//public class com.example.ujjwal.realvision2016.PortraitCameraView extends CameraBridgeViewBase implements Camera.PreviewCallback {
//
//    private static final int MAGIC_TEXTURE_ID = 10;
//    private static final String TAG = "com.example.ujjwal.realvision2016.PortraitCameraView";
//
//    private byte mBuffer[];
//    private Mat[] mFrameChain;
//    private int mChainIdx = 0;
...
//    }
//
//    public com.example.ujjwal.realvision2016.PortraitCameraView(Context context, int cameraId) {
//        super(context, cameraId);
//    }
//
//    public com.example.ujjwal.realvision2016.PortraitCameraView(Context context, AttributeSet attrs) {
//        super(context, attrs);
//    }
//
//    protected boolean initializeCamera(int width, int height) {
...
//                synchronized (com.example.ujjwal.realvision2016.PortraitCameraView.this) {
//                    try {
//                        while (!mCameraFrameReady && !mStopThread) {
//                            com.example.ujjwal.realvision2016.PortraitCameraView.this.wait();
//                        }
//                    } catch (InterruptedException e) {
//                        e.printStackTrace();
//                    }
